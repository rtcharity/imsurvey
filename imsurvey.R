...
prop.table(table(fetch_var('friendcount', na.rm = FALSE)))
table(fetch_var('friendcount', na.rm = FALSE), fetch_var('referrer', na.rm = FALSE))
prop.table(table(fetch_var('friendcount', na.rm = FALSE), fetch_var('referrer', na.rm = FALSE)), 2)
...
prop.table(table(fetch_var('gender', na.rm = FALSE)))
fetch_percent_table('gender')
table(fetch_var('gender', na.rm = FALSE), fetch_var('referrer', na.rm = FALSE))
prop.table(table(fetch_var('gender', na.rm = FALSE), fetch_var('referrer', na.rm = FALSE)), 2)
